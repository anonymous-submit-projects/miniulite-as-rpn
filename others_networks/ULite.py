...
class AxialDW(nn.Module):
    def __init__(self, dim, mixer_kernel, dilation=1, padding=0):
        super().__init__()
        h, w = mixer_kernel
        self.dw_h = nn.Conv2d(dim, dim, kernel_size=(h, 1), padding=(padding, 0), groups = dim, dilation = dilation)
        self.dw_w = nn.Conv2d(dim, dim, kernel_size=(1, w), padding=(0, padding), groups = dim, dilation = dilation)
...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, in_c, out_c, mixer_kernel = (7, 7)):
        super().__init__()
        self.dw = AxialDW(in_c, mixer_kernel = (7, 7), padding=3)
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, in_c, out_c, mixer_kernel = (7, 7)):
        ...
        self.dw = AxialDW(out_c, mixer_kernel = (7, 7), padding=3)
        self.act = nn.GELU()
...
class BottleNeckBlock(nn.Module):
    ...
    def __init__(self, dim):
        ...
        self.dw1 = AxialDW(gc, mixer_kernel = (3, 3), dilation=1, padding=1)
        self.dw2 = AxialDW(gc, mixer_kernel = (3, 3), dilation=2, padding=2)
        self.dw3 = AxialDW(gc, mixer_kernel = (3, 3), dilation=3, padding=3)
